...
def build_sim_prompt(race_data: dict) -> str:
    ...
    lines = [
        ...
        "Factor in the following, weighted by track condition:",
        "",
        "FAST/FIRM TRACK: Weight order = Pace figures (E1/E2) > Speed figures > Prime Power > Class > Running style",
        "SLOPPY/WET TRACK: Weight order = Prime Power > Class > Off-track form > Speed figures > Pace figures",
        "TURF: Weight order = Class > Prime Power > Speed figures > Running style (closers favored)",
        "",
        "Key insights from recent results:",
        "- On sloppy tracks, class dominates — pace figures become less reliable",
        "- Closers and mid-pack runners benefit more on off tracks than front-runners",
        "- On fast dirt, early pace advantage (low E1) is highly predictive",
        "- Prime Power is the most consistent predictor across all conditions",
        "",
        "Also factor in: best speed figure, days off, and running style fit.",
        "",
